<template>
  <div class="task-list-container">
    <el-form :model="searchQuery" ref="searchFrom" label-width="80px" label-suffix=":" size="small">
      <el-row :gutter="32">
        <el-col :span="6">
      ...
      <el-row :gutter="32">
        ...
        <el-col :span="6">
          <el-form-item label="创建人" prop="createBy">
            <el-input v-model="searchQuery.createBy" placeholder="请输入"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
        ...
        <el-col :span="4" style="text-align: right">
          ...
          <el-button size="small" @click="handleReset('searchFrom')">重置</el-button>
        </el-col>
      </el-row>
    </el-form>
    <div class="task-list-content">
      <div class="btn-wraper">
        <el-button type="primary" size="small" plain icon="el-icon-plus" @click="handleAdd">新建任务</el-button>
      ...
      <el-table v-loading="loading" :data="tableData" row-key="id" border>
        ...
        <el-table-column label="接收人数" prop="taskAllotNum" width="80"></el-table-column>
        ...
        <el-table-column label="操作" width="180">
          <template slot-scope="scope">
            ...
            <el-button v-if="scope.row.taskStatus < 4" size="mini" type="text" @click="handleUrge(scope.row.id)">催办</el-button>
            <el-button v-if="scope.row.taskStatus < 4" size="mini" type="text" @click="handleFinish(scope.row.id)">结束任务</el-button>
